...
period='Year'
m1_tr_best=['Strategy','W-L','1-1']
m1_itr_best=['Strategy','W-L','2-1']

m2_tr_best=['Strategy','W-L','1-1']
m2_itr_best=['Strategy','W-L','3-1']

m3_best=['Strategy','W-L','3-1']
...
m1_tr=m1_tr[m1_tr.index>datetime(2018,1,1)]
...
m1_tr_w=m1_tr_w[m1_tr_w.index>datetime(2018,1,1)]
...
m1_tr_l=m1_tr_l[m1_tr_l.index>datetime(2018,1,1)]
...
m1_itr=m1_itr[m1_itr.index>datetime(2018,1,1)]
...
m1_itr_w=m1_itr_w[m1_itr_w.index>datetime(2018,1,1)]
...
m1_itr_l=m1_itr_l[m1_itr_l.index>datetime(2018,1,1)]
...
m2_tr=m2_tr[m2_tr.index>datetime(2018,1,1)]
...
m2_tr_w=m2_tr_w[m2_tr_w.index>datetime(2018,1,1)]
...
m2_tr_l=m2_tr_l[m2_tr_l.index>datetime(2018,1,1)]
...
m2_itr=m2_itr[m2_itr.index>datetime(2018,1,1)]
...
m2_itr_w=m2_itr_w[m2_itr_w.index>datetime(2018,1,1)]
...
m2_itr_l=m2_itr_l[m2_itr_l.index>datetime(2018,1,1)]
...
m3=m3[m3.index>datetime(2018,1,1)]
...
m3_w=m3_w[m3_w.index>datetime(2018,1,1)]
...
m3_l=m3_l[m3_l.index>datetime(2018,1,1)]
...
nifty=ticker.history(start=date(2018,1,1),end=date(2022,1,1,))
...
#stats_df.to_csv('Results/Year/stats1.csv',index=False)
#risks_df.to_csv('Results/Year/risks1.csv',index=False)