...
n_months=len(m1_tr_r)
final_capital=m1_tr_r.values[-1][0]
initial_capital=m1_tr_r.values[0][0]
d['Mean']=(((final_capital/initial_capital)**(1/n_months))-1)*100
...
n_months=len(m1_itr_r)
final_capital=m1_itr_r.values[-1][0]
initial_capital=m1_itr_r.values[0][0]
d['Mean']=(((final_capital/initial_capital)**(1/n_months))-1)*100
...
n_months=len(m2_tr_r)
final_capital=m2_tr_r.values[-1][0]
initial_capital=m2_tr_r.values[0][0]
d['Mean']=(((final_capital/initial_capital)**(1/n_months))-1)*100
...
n_months=len(m2_itr_r)
final_capital=m2_itr_r.values[-1][0]
initial_capital=m2_itr_r.values[0][0]
d['Mean']=(((final_capital/initial_capital)**(1/n_months))-1)*100
...
n_months=len(m3_r)
final_capital=m3_r.values[-1][0]
initial_capital=m3_r.values[0][0]
d['Mean']=(((final_capital/initial_capital)**(1/n_months))-1)*100
...
stats_df.to_csv('Results/Day/stats2.csv',index=False)
risks_df.to_csv('Results/Day/risks2.csv',index=False)
stats_df.to_csv()